    ...
    <div class="bg-slate-50 text-slate-900 h-screen w-screen">
        <div class="lg:max-w-10/12 lg:mx-auto">
            <div class="min-h-screen flex flex-col lg:flex-row ">
                ...
                <div class="flex flex-col w-full lg:w-1/3 p-8 py-16 gap-8">
                    <section id="my-skills">
                        ...
                        <div class="grid grid-cols-2 gap-2 relative">
                            ...
                            <div class="w-full p-4 py-3 rounded-tl-2xl bg-emerald-800/80 backdrop-blur text-emerald-50 flex items-center gap-2 font-display">
                            ...
                            <div class="w-full p-4 py-3 rounded-tr-2xl bg-emerald-800/80 backdrop-blur text-emerald-50 flex items-center gap-2 font-display">
                            ...
                            <div class="w-full p-4 py-3 rounded-bl-2xl bg-emerald-800/80 backdrop-blur text-emerald-50 flex items-center gap-2 font-display">
                            ...
                            <div class="w-full p-4 py-3 rounded-br-2xl bg-emerald-800/80 backdrop-blur text-emerald-50 flex items-center gap-2 font-display">
                ...
                <div class="w-full lg:w-2/3 bg-pink-500 p-8 py-16">
